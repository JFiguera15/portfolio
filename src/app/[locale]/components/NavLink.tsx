...
export default function NavLinks() {
    ...
    return (
        <>
            <li className="drop-shadow-xl my-auto md:transition md:ease-in-out md:hover:-translate-y-2"><Link className={`link ${fullPath === '/' || fullPath === '/es' ? 'text-primary' : ''}`} href="/">{t("aboutMe")}</Link></li>
